...
const MOVE_SPEED_FAST = 9.6;   // food > 75 — faster than every animal, including "it" (8.6)
const MOVE_SPEED_NORMAL = 8.6; // 25..75 — matches top "it" speed
const MOVE_SPEED_SLOW = 5.0;   // food < 25 — slower than "it" animals
